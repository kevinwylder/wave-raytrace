...
public:
    ...
    // These are more "lagacy" kind of routines.
    ...
    //     are not re-used in multiple shader programs.
    ...
    //        the other shaders must be of type "coe_block".
    //    Returns the OpenGL handle (name) for the shader.
...
protected:
    enum ShaderType { vertex_shader, fragment_shader, geometryshader, code_block };
